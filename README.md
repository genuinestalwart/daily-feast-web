...
2. Create a `.env` file in the root directory and add the following environment variables:
    ...
    NUXT_AUTH0_APP_BASE_URL="your_app_base_url" # localhost or hosted frontend url
    ...
    NUXT_AUTH0_AUDIENCE="your_auth0_identifier"
    NUXT_AUTH0_SESSION_SECRET="your_auth0_session_secret" # create your own
    NUXT_PUBLIC_API_BASE_URL="your_api_base_url" # localhost or hosted backend url
    ```
